...
2. Inspect representative files with `read` for documents and the workbook instructions for XLSX. Identify worksheet names, header rows, fields, tables, sections, and differences within each group.
